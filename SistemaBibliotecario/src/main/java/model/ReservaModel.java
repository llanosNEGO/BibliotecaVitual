...
public class ReservaModel {
    ...
    public ReservaModel(int idReserva, int idUsuario, int idLibro, Calendar fechaReserva, String estado, int idAdministrador) {
    ...
    public ReservaModel(int idUsuario, int idLibro, Calendar fechaReserva, String estado, int idAdministrador) {
        this.idUsuario = idUsuario;
        this.idLibro = idLibro;
        this.fechaReserva = fechaReserva;
        this.estado = estado;
